...
extern unsigned char NdefBuffer_IMMO[RW_MAX_NDEF_FILE_SIZE];
...
extern unsigned char test_array[9];
...
extern void RW_NDEF_Write_Next(unsigned char *pCmd, unsigned short Cmd_size, unsigned char *Rsp, unsigned short *pRsp_size);
extern int RW_NDEF_SetMessage(unsigned char *pMessage, unsigned short Message_size, void *pCb);
