...
unsigned char NdefBuffer_IMMO[RW_MAX_NDEF_FILE_SIZE];
...
unsigned char test_array[9]={0x09,0x02,0x03,0x04,0x05,0x06,0x07,0x08,0x0A};


int RW_NDEF_SetMessage(unsigned char *pMessage, unsigned short Message_size, void *pCb)
{
