 ...
 *  -------------------------------------------------------------------------------------------------------------------
 *              File: ComM_Lcfg.c
 *   Generation Time: 2020-06-14 09:52:23
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
CONST(ComM_StateNotiFuncPtrType, COMM_CONST) ComM_UserModeNotiFunc[1] = {  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
  /* Index     UserModeNotiFunc                                                  Referable Keys */
  /*     0 */ Rte_Switch_UM_CN_NIO_ES6_RF_CAN_SR_V3_0_e01a4c57_currentMode    /* [/ActiveEcuC/ComM/ComMConfigSet/CN_NIO_ES6_RF_CAN_SR_V3_0_e01a4c57] */
};
#define COMM_STOP_SEC_CONST_UNSPECIFIED
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
...
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
VAR(ComM_ModeType, COMM_VAR_NOINIT) ComM_LastStateChange[1];  /* PRQA S 1514, 1533 */  /* MD_CSL_ObjectOnlyAccessedOnce */
#define COMM_STOP_SEC_VAR_NOINIT_8BIT
/*lint -save -esym(961, 19.1) */
#include "MemMap.h"  /* PRQA S 5087 */  /* MD_MSR_MemMap */
/*lint -restore */
