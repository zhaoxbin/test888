...
# define OS_CFG_DERIVATIVE_RH850_1649     (STD_ON)
...
# define Rte_Ev_Cyclic2_OsTask_BSW_SCHM_0_5ms     ((EventMaskType)4uLL)
# define Rte_Ev_Cyclic_OsTask_APP_0_10ms     ((EventMaskType)1uLL)
